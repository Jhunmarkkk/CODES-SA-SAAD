        ...
        <div id="editProfileContainer" class="hidden absolute bg-white rounded-lg shadow-md p-10 w-104 mt-20 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
            ...
            <form class="space-y-4">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ auth()->user()->fname }}" placeholder="Enter your name" class="mt-1 focus:ring-primary focus:border-primary block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
